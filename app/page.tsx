...
export default function HomePage() {
  ...
  async function handleGenerate() {
    ...
    if (avatar && !avatar.soulId) { notify('Este avatar necesita configurarse con 20 referencias en Creaciones.'); return; }
    setIsGenerating(true);
    try {
